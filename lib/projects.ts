...
export const projects: Project[] = [
  {
    ...
    n: '01',
    name: 'ヤスイミセ',
    type: 'Work · Web Service · 2026–Now',
  ...
  },
  {
    ...
    summaryShort:
      'メディア業界向けの業務オペレーション最適化を目的とした社内 PoC。Main + 6 Sub Agent のマルチエージェント基盤として設計。',
    summaryLong:
    ...
    motivation:
      '業務オペレーションに Agent を当てるとき、本当に難しいのは Agent そのものより「責務が日替わりで変わる PoC をどう支えるか」だった。マルチエージェント × 観測性の組み合わせで前例を作っておきたかった。',
