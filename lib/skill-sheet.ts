...
export const companies: Company[] = [
  ...
  },
  {
    id: 'dym',
    name: '株式会社DYM',
    period: '2023年01月～2023年12月',
    employment: '正社員',
  },
  {
    id: 'axis',
    name: '株式会社AXIS',
    period: '2020年04月～2022年12月',
    employment: '正社員',
  },
];
...
export const projectHistory: ProjectHistoryEntry[] = [
  // ── 株式会社アイタイズ ─────────────────────────────────
  {
    ...
    featured: true,
    slug: 'yasui-mise',
    name: 'スーパーマーケット価格比較Webサービス「ヤスイミセ」（企画〜実装まで全工程）',
    period: '2026年03月～現在',
  ...
  },
  {
    ...
    featured: true,
    slug: 'specpilot',
    name: 'SpecPilot（企画〜実装まで全工程）',
    period: '2026年03月～現在',
    position: 'フルスタックエンジニア',
    teamSize: '1 名（個人開発）',
    industry: 'SaaS / 受託開発支援',
    phases: ['要件定義', '基本設計', '詳細設計', '実装'],
    stack: ['PostgreSQL', 'Docker', 'TypeScript', 'Next.js', 'Prisma', 'Stripe', 'Docker Compose', 'ChatGPT', 'Claude', 'Gemini', 'Claude Code', 'Mastra'],
    description:
  ...
  },
  {
    ...
    featured: true,
    slug: 'cm-agent',
    name: 'メディア業界向け 業務オペレーション支援 AI エージェント基盤（PoC）',
    period: '2025年10月～2026年02月',
    position: 'フルスタックエンジニア',
    teamRole: 'リーダー',
    teamSize: '1-10 名',
    industry: 'メディア / 業務オペレーション',
    phases: ['要件定義', '基本設計', '詳細設計', '実装', '単体テスト', '結合テスト'],
    stack: ['Python', 'PostgreSQL', 'Docker', 'TypeScript', 'Next.js', 'OpenAPI', 'Docker Compose', 'Tailwind CSS', 'FastAPI', 'AI Agent', 'Claude Code', 'Coding Agent', 'Agent Development Kit'],
    description:
      '既存業務システムにおけるオペレーション最適化を目的とした社内 PoC。従来は手動で行われていた業務調整・編集作業を AI エージェントで支援する仕組みを開発。Human-in-the-Loop で AI が提案した編集案・調整案をオペレーターが確認・承認するワークフローを設計しました。',
    highlights: [
      'マルチエージェント構成による業務支援基盤の設計・実装（Main Agent + 6 Sub Agent のラウンドトリップ構成）',
      '各エージェントの責務分離、I/O コントラクト設計および実装',
      '既存業務 DB からのデータ取得層の設計',
      'FastAPI による OpenAPI コードファースト設計 + TypeScript SDK 自動生成パイプラインの構築',
      'W3C Trace Context によるフロント〜バックエンド〜AI エージェント間の trace_id 伝播設計',
  ...
  },
  {
    ...
    description:
      'データ分析 AI システムにおけるフロントエンド改修を担当。UI の表示ずれ修正や既存機能の改善対応を実施。画面表示・操作性に関する不具合修正を行い、ユーザビリティ向上に貢献。既存コードを踏まえた保守・運用改善を担当。',
  },
  {
  ...
  // ── 株式会社DYM ────────────────────────────────────────
  {
    ...
    description:
      '求人ボックスへの応募データをリアルタイムで検知し、顧客ごとの設定に応じた応募通知メールを自動送信するシステムを構築。通知処理の自動化により運用工数削減に貢献。',
  },
  {
    id: 'kbox-ats',
    companyId: 'dym',
    ...
    stack: ['Python', 'AWS', 'Google Cloud'],
    description:
      '求人ボックスからの応募情報を検知し、各種 ATS サイトへ応募情報を自動転記するシステムを構築。手作業による入力業務を削減し、業務効率化を実現。',
  },
  {
    id: 'kbox-rpa',
    companyId: 'dym',
    name: '求人媒体運用自動化 RPA システム構築',
    period: '2023年01月～2023年12月',
    position: 'バックエンドエンジニア',
    teamSize: '1-10 名',
    industry: 'HR / 広告運用',
    ...
    stack: ['Python', 'AWS', 'Google Cloud'],
    description:
      '求人媒体運用業務の自動化を目的とした RPA システムを構築。求人データの加工・登録処理を自動化し、媒体運用における業務効率化を推進。企画、開発、保守運用まで一貫して担当。',
  },
  ...
  // ── 株式会社AXIS ───────────────────────────────────────
  {
    ...
    companyId: 'axis',
    name: '業務帳票電子化システム リプレース',
    period: '2022年07月～2022年12月',
    position: 'バックエンドエンジニア',
    teamRole: 'メンバー',
    teamSize: '50-100 名',
    industry: '業務システム / 帳票',
    ...
    description:
      '紙帳票削減を目的とした既存システムのリプレース案件に参画。要件定義、詳細設計、開発、単体テスト、結合テスト、総合テストまでを担当し、業務効率化に貢献。',
  },
  {
    id: 'own-hp',
    companyId: 'axis',
    ...
    description:
      '自社コーポレートサイトの新規開発を担当。デザイン作成からフロントエンド実装、テストまで一貫して対応し、ユーザビリティを意識したサイト制作を実施。',
  },
  {
    id: 'broadcast-core',
    companyId: 'axis',
    ...
    description:
      '大規模基幹システム刷新案件に参画。要件定義から設計、開発、総合テストまで一連の工程を担当。一部期間ではリーダー業務も経験し、チーム内の進行管理やレビュー対応を実施。',
  },
  {
    id: 'reservation',
    companyId: 'axis',
    ...
    teamRole: 'メンバー',
    teamSize: '1-10 名',
    industry: '業務システム / 予約管理',
    phases: ['詳細設計', '実装', '単体テスト', '結合テスト'],
    stack: ['JavaScript', 'HTML', 'Google Cloud', 'Bootstrap'],
    description:
      '施設予約管理システムの新規開発案件に参画。詳細設計、開発、単体・結合テストを担当し、予約管理業務の効率化を支援。',
  },
];
