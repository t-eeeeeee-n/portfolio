...
export const projectHistory: ProjectHistoryEntry[] = [
  ...
  },
  {
    ...
    description:
      '業務オペレーションにおける編集・最適化作業を Multi-Agent で支援する社内 PoC。マルチエージェント構成（Google ADK / A2A Protocol）で属人化の解消と作業効率化を目指した。Human-in-the-Loop で編集案を提示し、オペレーターが承認するワークフロー。',
    highlights: [
